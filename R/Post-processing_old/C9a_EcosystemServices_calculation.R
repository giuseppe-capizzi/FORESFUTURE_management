...
ES2_function_period <- function(ALL, model) {
  ...
  ES2_20 <- CutBiomass_20 |>
    ...
    mutate(ES2_AdultTreeBiomassChange = AdultTreeBiomassChange,
           ...
           ES2_SequestrPlusFirewood = AdultTreeBiomassChange + CutBiomassStructure + CutBiomassAdultFirewood,
...
generate_ES_table <- function(type = "period", test = FALSE, model = "FORDYN") {
  ...
  if(model=="FORDYN") {
    ...
    cli::cli_progress_step("BAU/RCP85")
    BAU_rcp85 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/BAU_mpiesm_rca4_rcp85.rds"), model, BAU_rcp85_MF)
    cli::cli_progress_step("AMF/RCP45")
    AMF_rcp45 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/AMF_mpiesm_rca4_rcp45.rds"), model, BAU_rcp45_MF)
    cli::cli_progress_step("AMF/RCP85")
    AMF_rcp85 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/AMF_mpiesm_rca4_rcp85.rds"), model, BAU_rcp85_MF)
    cli::cli_progress_step("RSB/RCP45")
    RSB_rcp45 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/RSB_mpiesm_rca4_rcp45.rds"), model, BAU_rcp45_MF)
    cli::cli_progress_step("RSB/RCP85")
    RSB_rcp85 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/RSB_mpiesm_rca4_rcp85.rds"), model, BAU_rcp85_MF)
    cli::cli_progress_step("ASEA/RCP45")
    ASEA_rcp45 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/ASEA_mpiesm_rca4_rcp45.rds"), model, BAU_rcp45_MF)
    cli::cli_progress_step("ASEA/RCP85")
    ASEA_rcp85 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/ASEA_mpiesm_rca4_rcp85.rds"), model, BAU_rcp85_MF)
    cli::cli_progress_step("ACG/RCP45")
    ACG_rcp45 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/ACG_mpiesm_rca4_rcp45.rds"), model, BAU_rcp45_MF)
    cli::cli_progress_step("ACG/RCP85")
    ACG_rcp85 <- ES_function(type, readRDS("Rdata/FORMES/annual_indicators_1206/ACG_mpiesm_rca4_rcp85.rds"), model, BAU_rcp85_MF)
    # cli::cli_progress_step("NOG/RCP45")
...
ES_period_MEDFATE <- ES_period_MEDFATE |>
  left_join(nfiplot[,c("id")], by="id") |>
  sf::st_as_sf()
# saveRDS(ES_period_MEDFATE, "Rdata/ES/ES_period_MEDFATE.rds")
saveRDS(ES_period_MEDFATE, "Rdata/ES/ES_period_MEDFATE_0209.rds")
# 
ES_state_MEDFATE <- generate_ES_table("state", FALSE, model = "FORDYN")
ES_state_MEDFATE <- ES_state_MEDFATE |>
  left_join(nfiplot[,c("id")], by="id") |>
  sf::st_as_sf()
saveRDS(ES_state_MEDFATE, "Rdata/ES/ES_state_MEDFATE_0209.rds")
# 
