      ...
      for(climate_model in c("mpiesm_rca4")) {
        for(climate_scen in c("rcp45", "rcp85")) {
          ...
          if(file.exists(bind_file)) {
            ...
            df <- dplyr::bind_rows(df, scen_list$volume_table) 
          }
        }
      }
    }
...
ggsave("Plots/medfate/GrowthByDecade_provinces.png", p1a, width = 16, height = 8)

p1b<-plot_volume_var(VOL, "Growth", "Growth (m3)", aggregateProvinces = TRUE, provinces = target_provinces, scenarios = target_scenarios)
ggsave("Plots/medfate/GrowthByDecade.png", p1b, width = 9, height = 5)
...
ggsave("Plots/medfate/MortalityByDecade_provinces.png", p2a, width = 16, height = 8)
...
ggsave("Plots/medfate/MortalityByDecade.png", p2b, width = 9, height = 5)
...
ggsave("Plots/medfate/ExtractionByDecade_provinces.png", p3a, width = 16, height = 8)
...
ggsave("Plots/medfate/ExtractionByDecade.png", p3b,  width = 9, height = 5)
...
ggsave("Plots/medfate/ExtractionRateByDecade_provinces.png", p4a, width = 16, height = 8)
...
p4b<- plot_volume_var(VOL, "ExtractionRate", "Extraction rate (% of growth)", aggregateProvinces = TRUE, provinces = target_provinces, scenarios = target_scenarios)+
  ...
  geom_hline(yintercept = 70, linetype="dotted")+
  geom_hline(yintercept = 100, linetype="dotted")
ggsave("Plots/medfate/ExtractionRateByDecade.png", p4b, width = 9, height = 5)
...
ggsave("Plots/medfate/ExtractionTargetByDecade_provinces.png", p5a, width = 16, height = 8)
...
ggsave("Plots/medfate/ExtractionTargetByDecade.png", p5b, width = 9, height = 5)
...
ggsave("Plots/medfate/NominalDemandByDecade_provinces.png", p6a, width = 16, height = 8)
...
ggsave("Plots/medfate/NominalDemandByDecade_provinces.png", p6b, width = 9, height = 5)
...
p7a<- plot_volume_var(VOL, "SatisfactionRate", "Satisfaction (% of demand)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios)+
  geom_hline(yintercept = 100, linetype="dotted")
ggsave("Plots/medfate/SatisfactionRate_provinces.png", p7a, width = 16, height = 8)
...
p7b<- plot_volume_var(VOL, "SatisfactionRate", "Satisfaction (% of demand)", aggregateProvinces = TRUE, provinces = target_provinces, scenarios = target_scenarios)+
  geom_hline(yintercept = 100, linetype="dotted")
ggsave("Plots/medfate/SatisfactionRate.png", p7b, width = 9, height = 5)
...
ggsave("Plots/medfate/Precipitation.png", p1, width = 9, height = 5)
...
ggsave("Plots/medfate/PET.png", p2, width = 9, height = 5)
...
ggsave("Plots/medfate/PPET.png", p3, width = 9, height = 5)
rm(p1, p2, p3)
gc()
...
ggsave("Plots/medfate/BasalArea_provinces.png", p1a, width = 16, height = 8)
...
ggsave("Plots/medfate/BasalArea.png", p1b, width = 9, height = 5)
...
ggsave("Plots/medfate/TreeDensity_provinces.png", p2a, width = 16, height = 8)
...
ggsave("Plots/medfate/TreeDensity.png", p2b, width = 9, height = 5)
...
ggsave("Plots/medfate/QMD_provinces.png", p3a, width = 16, height = 8)
...
ggsave("Plots/medfate/QMD.png", p3b, width = 9, height = 5)
...
ggsave("Plots/medfate/cvDBH_provinces.png", p4a, width = 16, height = 8)
...
ggsave("Plots/medfate/cvDBH.png", p4b, width = 9, height = 5)
rm(p4a, p4b)
gc()


p5 <-plot_var(ALL, "TreeRichness", "Tree species richness", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/TreeRichness_provinces.png", p5, width = 16, height = 8)

p6<-plot_var(ALL, "ShrubRichness", "Shrub species richness", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/ShrubRichness_provinces.png", p6, width = 16, height = 8)

p7<-plot_var(ALL, "ShrubCover", "Overall shrub cover (%)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/ShrubCover_provinces.png", p7, width = 16, height = 8)
rm(p5, p6, p7)
gc()
...
ggsave("Plots/medfate/LAImax_provinces.png", p8a, width = 16, height = 8)
...
ggsave("Plots/medfate/LAImax.png", p8b, width = 9, height = 5)
rm(p8a, p8b)
gc()
...
ggsave("Plots/medfate/TreeLAI_provinces.png", p9a, width = 16, height = 8)
...
ggsave("Plots/medfate/TreeLAI.png", p9b, width = 9, height = 5)
rm(p9a, p9b)
gc()
...
ggsave("Plots/medfate/ShrubLAI_provinces.png", p10a, width = 16, height = 8)
...
ggsave("Plots/medfate/ShrubLAI.png", p10b, width = 9, height = 5)
rm(p10a, p10b)
gc()


p11 <- plot_var(ALL, "Herb_lai", "Herb LAI (m2/m2)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/HerbLAI_provinces.png", p11, width = 16, height = 8)
...
ggsave("Plots/medfate/TotalLAI_provinces.png", p12a, width = 16, height = 8)
...
ggsave("Plots/medfate/TotalLAI.png", p12b, width = 9, height = 5)
rm(p11,
   p12a, p12b)
gc()
...
# Function -----------
p13<-plot_var(ALL, "GrossPrimaryProduction", "Gross Primary Production (gC/m2/yr)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/GPP_provinces.png", p13, width = 16, height = 8)

p14<-plot_var(ALL, "NetPrimaryProduction", "Net Primary Production (gC/m2/yr)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/NPP_provinces.png", p14, width = 16, height = 8)

p15<-plot_var(ALL, "WaterUseEfficiency", "Water Use Efficiency (gC/mm)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/WUE_provinces.png", p15, width = 16, height = 8)

p16<-plot_var(ALL, "CarbonUseEfficiency", "Carbon Use Efficiency (gC synthesis/gC)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/CUE_provinces.png", p16, width = 16, height = 8)
...
ggsave("Plots/medfate/StemPLC_provinces.png", p17a, width = 16, height = 8)
...
ggsave("Plots/medfate/StemPLC.png", p17b, width = 9, height = 5)

p18<-plot_var(ALL, "PlantStress", "Maximum annual plant drought stress ([0-1])", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/PlantStress_provinces.png", p18, width = 16, height = 8)
...
# Timber stock ------
p19<-plot_var(ALL, "AllVolume", "Tree volume stock (m3/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/VolumeStock_provinces.png", p19, width = 16, height = 8)

p20<-plot_var(ALL, "AllVolumeExt", "Tree volume stock (m3)", stand_agg_fun = "sum", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/VolumeStockExtensive_provinces.png", p20, width = 16, height = 8)

p21<-plot_var(ALL, "VolumeStructure", "Structural wood volume stock (m3/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/VolumeStructureStock_provinces.png", p21, width = 16, height = 8)

p22<-plot_var(ALL, "VolumeFirewood", "Fire wood volume stock (m3/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/VolumeFirewoodStock_provinces.png", p22, width = 16, height = 8)

rm(p19, p20, p21, p22)
gc()

# Biomass stock ---------
p23<-plot_var(ALL, "LiveBiomass", "Woody live biomass (Mg CO2/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/LiveWoodyBiomass_provinces.png", p23, width = 16, height = 8)

p24<-plot_var(ALL, "TreeBiomass", "Tree biomass (Mg CO2/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/LiveTreeBiomass_provinces.png", p24, width = 16, height = 8)

p25 <- plot_var(ALL, "ShrubBiomass", "Shrub biomass (Mg CO2/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/LiveShrubBiomass_provinces.png", p25, width = 16, height = 8)

rm(p23, p24, p25)
gc()

# Dead biomass ------------
p26 <- plot_var(ALL, "DeadBiomass", "Dead biomass (Mg CO2/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/DeadWoodyBiomass_provinces.png", p26, width = 16, height = 8)

p27<-plot_var(ALL, "CumulativeDeadBiomass", "Cumulative dead biomass (Mg CO2/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/CumulativeDeadWoodyBiomass_provinces.png", p27, width = 16, height = 8)

p28<-plot_var(ALL, "CumulativeTreeDeadBiomass", "Cumulative tree dead biomass (Mg CO2/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/CumulativeDeadTreeBiomass_provinces.png", p28, width = 16, height = 8)

p29<-plot_var(ALL, "CumulativeShrubDeadBiomass", "Cumulative shrub dead biomass (Mg CO2/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/CumulativeDeadTreeBiomass_provinces.png", p29, width = 16, height = 8)
...
ggsave("Plots/medfate/CumulativeDeadWoodyBiomassCause_provinces.png", p30, width = 16, height = 8)
...
ggsave("Plots/medfate/CumulativeDeadTreeBiomassCause_provinces.png", p31, width = 16, height = 8)
...
ggsave("Plots/medfate/CumulativeDeadShrubBiomassCause_provinces.png", p32, width = 16, height = 8)
...
ggsave("Plots/medfate/DeadWoodyBiomassCause_provinces.png", p30, width = 16, height = 8)
...
ggsave("Plots/medfate/DeadTreeBiomassCause_provinces.png", p31, width = 16, height = 8)
...
ggsave("Plots/medfate/DeadShrubBiomassCause_provinces.png", p32, width = 16, height = 8)
...
# Wood extraction --------
p33<-plot_var(ALL, "CutAll", "Annual tree volume extraction (m3/ha/yr)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/AnnualTreeVolumeExtraction_provinces.png", p33, width = 16, height = 8)
...
p34<-plot_var(ALL, "CumulativeCutAll", "Cumulative tree volume extraction (m3/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/CumulativeTreeVolumeExtraction_provinces.png", p34, width = 16, height = 8)

# plot_var(ALL, "CumulativeCutAllExt", "Cumulative tree volume extraction (m3)", stand_agg_fun = "sum")
p35<-plot_var(ALL, "CumulativeCutFirewood", "Cumulative firewood volume extraction (m3/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios)
ggsave("Plots/medfate/CumulativeFirewoodVolumeExtraction_provinces.png", p35, width = 16, height = 8)

p36<-plot_var(ALL, "CumulativeCutStructure", "Cumulative structure volume extraction (m3/ha)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios)
ggsave("Plots/medfate/CumulativeStructureVolumeExtraction_provinces.png", p36, width = 16, height = 8)
...
ggsave("Plots/medfate/AnnualBlueWater_provinces.png", p37a, width = 16, height = 8)
...
ggsave("Plots/medfate/AnnualBlueWater.png", p37b, width = 9, height = 5)
...
ggsave("Plots/medfate/CumulativeBlueWater_provinces.png", p38a, width = 16, height = 8)
...
ggsave("Plots/medfate/CumulativeBlueWater.png", p38b, width = 9, height = 5)
...
ggsave("Plots/medfate/AnnualRunoffCoefficient_provinces.png", p39a, width = 16, height = 8)
...
ggsave("Plots/medfate/AnnualRunoffCoefficient.png", p39b, width = 9, height = 5)
...
ggsave("Plots/medfate/CumulativeRunoffCoefficient_provinces.png", p40a, width = 16, height = 8)
...
ggsave("Plots/medfate/CumulativeRunoffCoefficient.png", p40b, width = 9, height = 5)
...
p41 <- plot_var(ALL, "Cm_mean", "Cm (mm)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/CmMean_provinces.png", p41, width = 16, height = 8)

rm(p41)
gc()

# Fire hazard -------
p42 <- plot_var(ALL, "Tree_fuel", "Tree fine fuel (kg/m2)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/TreeFuel_provinces.png", p42, width = 16, height = 8)

p43 <- plot_var(ALL, "Shrub_fuel", "Shrub fine fuel (kg/m2)", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/ShrubFuel_provinces.png", p43, width = 16, height = 8)

p44 <- plot_var(ALL, "SFP", "Surface fire potential [0-9]", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/SurfaceFirePotential_provinces.png", p44, width = 16, height = 8)

p45 <- plot_var(ALL, "CFP", "Crown fire potential [0-9]", aggregateProvinces = FALSE, provinces = target_provinces, scenarios = target_scenarios, se = se)
ggsave("Plots/medfate/CrownFirePotential_provinces.png", p45, width = 16, height = 8)
