...
```{r, echo = FALSE}
knitr::kable(table_ES_period(ES_period, ES3_BlueWater), digits = 0)
```
...
```{r, echo = FALSE}
knitr::kable(table_ES_period(ES_period, ES3_RunoffCoefficient), digits = 1)
```
...
```{r, echo = FALSE}
knitr::kable(table_ES_period(ES_period, ES4_ErosionMitigation), digits = 1)
```
...
```{r, echo = FALSE}
knitr::kable(table_ES_state(ES_state, ES5_RecreationalValue), digits = 2)
```
...
```{r, echo = FALSE}
knitr::kable(table_ES_period(ES_period, ES6_SurfaceFirePotential), digits = 2)
```
...
```{r, echo = FALSE}
knitr::kable(table_ES_period(ES_period, ES6_CrownFirePotential), digits = 2)
```
