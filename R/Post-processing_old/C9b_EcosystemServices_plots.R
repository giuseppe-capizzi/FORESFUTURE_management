...
ES_state_FORMES <- readRDS("Rdata/ES/ES_state_FORMES.rds")
ids_formes <- unique(ES_state_FORMES$id)
n_plots_state <- length(ids_formes)
ES_state_MEDFATE  <- readRDS("Rdata/ES/ES_state_MEDFATE.rds")|>
...
ES_period_MEDFATE  <- readRDS("Rdata/ES/ES_period_MEDFATE.rds")|>
  mutate(id = as.character(as.numeric(substr(id, 1,6)))) |>
  filter(id %in% ids_formes)
...
map_scenario_states<-function(ES_state, var, breaks, breaks_diff, units, type = "div", palette = "YlGnBu", draw_formes = TRUE) {
  ...
  ggsave2(paste0("Plots/new_ES_maps/", var, "_medfate_rcp45.png"),m_ES, width = 13, height = 22, bg = "white")
  ...
  ggsave2(paste0("Plots/new_ES_maps/",var,"_medfate_rcp85.png"),m_ES, width = 13, height = 22, bg = "white")
  if(draw_formes) {
    m_ES <- map_scenario_state(ES_state[ES_state$Model=="FORMES",], model = "FORMES",var = var, climate_scen = "RCP45",
                               breaks = breaks, breaks_diff = breaks_diff, units = units)
    ggsave2(paste0("Plots/new_ES_maps/",var,"_formes_rcp45.png"),m_ES, width = 13, height = 22, bg = "white")
    m_ES <- map_scenario_state(ES_state[ES_state$Model=="FORMES",], model = "FORMES", var = var, climate_scen = "RCP85",
                               breaks = breaks, breaks_diff = breaks_diff, units = units)
    ggsave2(paste0("Plots/new_ES_maps/",var,"_formes_rcp85.png"),m_ES, width = 13, height = 22, bg = "white")
  }
}
...
map_scenario_periods<-function(ES_period, var, breaks, breaks_diff, units, type = "div", palette = "YlGnBu", draw_formes = TRUE) {
  m_ES <- map_scenario_period(ES_period[ES_period$Model=="MEDFATE",], model = "MEDFATE", var = var, climate_scen = "RCP45", 
                             breaks = breaks, breaks_diff = breaks_diff, units = units, type = type, palette = palette)
  ggsave2(paste0("Plots/ES_maps_1206/", var, "_medfate_rcp45.png"),m_ES, width = 13, height = 22, bg = "white")
  m_ES <- map_scenario_period(ES_period[ES_period$Model=="MEDFATE",], model = "MEDFATE",var = var, climate_scen = "RCP85", 
                             breaks = breaks, breaks_diff = breaks_diff, units = units)
  ggsave2(paste0("Plots/ES_maps_1206/",var,"_medfate_rcp85.png"),m_ES, width = 13, height = 22, bg = "white")
  if(draw_formes) {
    m_ES <- map_scenario_period(ES_period[ES_period$Model=="FORMES",], model = "FORMES",var = var, climate_scen = "RCP45",
                                breaks = breaks, breaks_diff = breaks_diff, units = units)
    ggsave2(paste0("Plots/ES_maps_1206/",var,"_formes_rcp45.png"),m_ES, width = 13, height = 22, bg = "white")
    m_ES <- map_scenario_period(ES_period[ES_period$Model=="FORMES",], model = "FORMES", var = var, climate_scen = "RCP85",
                                breaks = breaks, breaks_diff = breaks_diff, units = units)
    ggsave2(paste0("Plots/ES_maps_1206/",var,"_formes_rcp85.png"),m_ES, width = 13, height = 22, bg = "white")
  }
}
...
ggsave2("Plots/new_ES_dynamics/ES1_VolumeStructure.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES1_VolumeAdultFirewood.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES1_CutStructure.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES1_CutAdultFirewood.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES2_AdultTreeBiomass.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES2_AdultTreeBiomassChange.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES2_CutBiomassStructure.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES2_AdultTreeBiomassSequestr.png",d_ES, width = 10, height = 8, bg = "white")
...
d_ES <- plot_ES_period(ES_period, ES2_LiveBiomassSequestr, ylab = "Embornal de carboni total (Mg C/ha/any)", 
                       outliers = c(-50,50), ylim = c(-1,6), add_formes = T)
ggsave2("Plots/new_ES_dynamics/ES2_LiveBiomassSequestr.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES3_LAI.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES3_BlueWater.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES3_RunoffCoefficient.png",d_ES, width = 10, height = 8, bg = "white")
...
d_ES <- plot_ES_period(ES_period, ES4_ErosionMitigation, ylab = "Mitigació de l'erosió (Mg/ha/any)", ylim = c(100,175), 
                # outlier = 3000,
                add_formes = TRUE)
ggsave2("Plots/new_ES_dynamics/ES4_ErosionMitigation.png",d_ES, width = 10, height = 8, bg = "white")
...
ggsave2("Plots/new_ES_dynamics/ES5_RecreationalValue.png",d_ES, width = 10, height = 8, bg = "white")
...
d_ES <- plot_ES_period(ES_period, ES6_SurfaceFirePotential, ylab = "Risk d'incendi de superficie [0-9]", ylim = c(5,9), 
                       add_formes = TRUE)
ggsave2("Plots/new_ES_dynamics/ES6_SurfaceFirePotential.png",d_ES, width = 10, height = 8, bg = "white")
...
d_ES <- plot_ES_period(ES_period, ES6_CrownFirePotential, ylab = "Risk d'incendi de capçada [0-9]", ylim = c(2,7), 
                       add_formes = TRUE)
ggsave2("Plots/new_ES_dynamics/ES6_CrownFirePotential.png",d_ES, width = 10, height = 8, bg = "white")
